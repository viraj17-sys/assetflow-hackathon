...
button{width:100%;padding:15px;background:#1565C0;color:white;border:none;border-radius:10px;font-size:18px;cursor:pointer;margin-top:8px;}
...
<div class="box">
  ...
  <a href="forgot-password.php">Resend / Back</a>
</div>
</body>
</html>